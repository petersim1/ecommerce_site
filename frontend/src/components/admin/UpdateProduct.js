                            ...
                            <form className="shadow-lg" onSubmit={submitHandler} encType='multipart/form-data'>
                                ...
                                <div className='form-group'>
                                    ...
                                    {oldImages && oldImages.map((img,ind) => (
                                        <img key={ind} src={img.url} alt={img.url} className="mt-3 mr-2" width="55" height="52" />
                                    ))}

                                    {imagesPreview.map((img,ind) => (
                                        <img src={img} key={ind} alt="Images Preview" className="mt-3 mr-2" width="55" height="52" />
                                    ))}
